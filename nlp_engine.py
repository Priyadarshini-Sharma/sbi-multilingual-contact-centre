...
_INTENT_KEYWORDS = {
    # --- New services (checked first: more specific phrasing, avoids
    #     being misclassified as generic Fraud/Loans below) -------------
    "Deceased Claim Facilitation": [
        "deceased", "passed away", "death certificate", "legal heir",
        "nominee claim", "father's account", "mother's account", "expired",
        "demise", "claim settlement",
    ],
    ...
    "YONO Companion (Co-Browsing)": [
        "yono", "co-browsing", "cobrowsing", "screen share",
        "help using the app", "guide me through", "show me how to use",
        "app is confusing", "which button",
    ],
...
if __name__ == "__main__":
    samples = [
        "I lost my wallet at the station and my bank details are gone, block everything!",
        "मेरे खाते का बैलेंस बताओ",
        "मेरा कार्ड चोरी हो गया है",
        "Thank you, my issue is resolved, great service.",
        "My father passed away last month and I need to claim his account as legal heir",
        "I'm confused using the YONO app, can you guide me through UPI registration",
